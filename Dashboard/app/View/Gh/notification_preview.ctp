...
<head>
<link href="http://localhost/growth-heacker_css/style_gh1.css" rel="stylesheet" />
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
<script type="text/javascript">
$(document).ready(function(){
    $("#simple_blue_<?php echo $alignment; ?>").fadeIn(500);
	var h=$('#simple_blue_<?php echo $alignment; ?>').height();
	h=h+40;
...
<body style="margin:20px 7px 0px 0px;">
	<div id="simple_blue_<?php echo $alignment; ?>" class="simple_blue" style="width:<?php echo @$width; ?> !important">
	<a href="#" class="close" id="close_button">X</a>
